...
const Banner = () => {
  return (
    <div className="relative mb-20 mt-10">
      <img className="rounded-t-xl" src={banner2} alt="Banner" />
      <div className="absolute inset-0 bg-black opacity-50 rounded-t-xl"></div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <h2 className=" text-white text-4xl text-center">The Biggest</h2>
        <h2 className="my-4 text-white text-6xl font-bold text-center">
          Event Planner
        </h2>
        <p className="text-white text-xl  text-center tracking-[4px]">
